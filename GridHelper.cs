...
namespace MP3Manager
{
    ...
    {
        public static void SetGridColumns(DataGridView mainGrid, bool isMusic)
        {
            if(isMusic)
            {
        ...
        public static object[] FileToGridRow(AudioFile file, String key)
        {
            return new object[]{
                key,
                file.Title,
        ...
        public static object[] FileToGridRow(VideoFile file, String key)
        {
            return null;
        }

        public static void SetAudioFile(AudioFile fileData, DataGridViewRow row)
        {
